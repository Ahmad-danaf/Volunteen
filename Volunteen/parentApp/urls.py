...
urlpatterns = [
    path('inactive/<int:child_id>/', views.inactive_home, name='inactive_home'),
    ...
    path('all-children-leaderboard/<int:child_id>/', views.all_children_points_leaderboard, name='all_children_leaderboard'),
